...
/**
 * Maximum number of results for "all matching" bulk operations.
 *
 * Single source of truth for the bulk limit: it gates the "act on all
 * matching" UI here AND is used as the `per_page` size when fetching the
 * matching IDs (see `jobDataService.fetchMatchingJobIds`). Keeping them
 * identical prevents silent truncation of bulk actions.
 */
export const MAX_BULK_RESULTS = 10000;
